...
(
	...
	ticketmedio numeric,
	ticketdaultimacompra numeric,
	lojamaisfrequente varchar(30),
	lojadaultimacompra varchar(30)
)
;

alter table base_teste owner to postgres
;

create or replace function fn_cnpj_cpf(text) returns boolean
	immutable
	language plpgsql
as $$
DECLARE
...
alter function fn_cnpj_cpf(text) owner to postgres
;


Select * from base_teste
